 ...
 * {@link MP3Fragment.OnFragmentInteractionListener} interface
...
public class MP3Fragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View viewMP3 = inflater.inflate(R.layout.fragment_mp3, container, false);
        mPlayer = MediaPlayer.create(getActivity(), R.raw.guitarra);

        Button btnPlay = viewMP3.findViewById(R.id.btnPlay);
        Button btnPause = viewMP3.findViewById(R.id.btnPause);
        Button btnStop = viewMP3.findViewById(R.id.btnStop);
